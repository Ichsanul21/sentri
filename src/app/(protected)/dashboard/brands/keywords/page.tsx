...
export default function KeywordsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <Breadcrumbs items={[{ label: "Brand", href: "/dashboard/brands" }, { label: "Keywords" }]} />
      ...
      <WidgetCard title="Keywords">
        ...
        <div className="flex flex-wrap gap-2 mb-3 animate-stagger">
          {keywords.map((kw) => (
            <Badge key={kw} variant="lime" className="gap-1 px-2 py-1 transition-all duration-200 hover:scale-105">
              <Tag size={12} />
              {kw}
      ...
      <WidgetCard title="Hashtags">
        ...
        <div className="flex flex-wrap gap-2 mb-3 animate-stagger">
          {hashtags.map((h) => (
            <Badge key={h} variant="sentiment-positive" className="gap-1 px-2 py-1 transition-all duration-200 hover:scale-105">
              <Hash size={12} />
              {h}
