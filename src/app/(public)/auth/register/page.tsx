  ...
  return (
    <div className="bg-surface-night rounded-[12px] border border-hairline-violet p-8 space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-[30px] font-medium leading-[1.2]">Daftar</h1>
        <p className="text-[16px] text-on-dark-muted">Mulai pantau sentimen brand Anda</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[16px] font-medium leading-[1.5] text-on-primary">Nama Lengkap</label>
          <input
            type="text"
            value={name}
