...
export default function BrandDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Link href="/brand" className="flex items-center gap-2 text-[14px] text-on-dark-muted hover:text-on-primary transition-colors">
        <ArrowLeft size={16} /> Back to Brands
      </Link>

      <Breadcrumbs items={[{ label: "Brand", href: "/brand" }, { label: brand.brandName }]} />
